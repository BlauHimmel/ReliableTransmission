...
import Checksum
from tests import BasicTest, RandomDropTest, TimeOutTest, lowTimetext
...
def tests_to_run(forwarder):
    ...
    #BasicTest.BasicTest(forwarder, "2287.pptx")

    #lowTimetext.lowTimetext(forwarder, '2287.pptx')
    
    RandomDropTest.RandomDropTest(forwarder, "2287.pptx")
    
    #TimeOutTest.TimeOutTest(forwarder, "2287.pptx")
